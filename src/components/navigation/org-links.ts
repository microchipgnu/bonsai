export const navLinkData = {
  ...
  gateways: {
    title: 'Gateways',
    description: 'Discover different entry points to the Blockchain Operating System (BOS)',
    link: '/gateways',
  },
  sandbox: {
    title: 'Sandbox',
  ...
  chat: {
    title: 'Chat AI',
    description: 'Use everyday language to interact with the Blockchain Operating System',
    link: '/chat',
  },
  people: {
    title: 'People',
  ...
  events: {
    title: 'Events',
    description: 'Join us for one of our upcoming in-person, virtual, or hybrid events',
    link: '/events',
  },
  developers: {
    title: 'Developers',
  ...
  founders: {
    title: 'Founders',
    description: 'Accelerate the growth of your project and reach new audiences',
    link: '/horizon',
  },
  earlyAdopters: {
